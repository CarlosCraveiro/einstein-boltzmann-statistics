...
#let poster(
  ...
  footer_text_color: "Footer Text Hex Color Code",
  ...
  set text(font: "STIX Two Text", size: body_text_size)
  ...
  footer_url_email_font_size = int(footer_url_email_font_size) * 1pt
  ...
  set page(
    ...
    footer: [
      ...
      #block(
        ...
        radius: 10pt,
        [
          #text(font: "Courier", size: footer_url_email_font_size, footer_url, fill: rgb(footer_text_color)) 
          #h(1fr) 
          #text(size: footer_text_font_size, smallcaps(footer_text), fill: rgb(footer_text_color)) 
          #h(1fr) 
          #text(font: "Courier", size: footer_url_email_font_size, footer_email_ids, fill: rgb(footer_text_color))
        ]
      )
    ]
  )
